    ...
    <section className="animals" id="wahana">
      ...
      <div className="box-container">
        <div className="box">
          ...
          <div className="content">
            <h3 style={{color:"orange"}}>Terapi Ikan</h3>
          </div>
        </div>
        <div className="box">
          <img src="src/assets/images/wahana-2.jpg" alt="" />
          <div className="content">
            <h3 style={{color:"orange"}}>Speedboat</h3>
          </div>
        </div>
        <div className="box">
          <img src="src/assets/images/wahana-3.jpeg" alt="" />
          <div className="content">
            <h3 style={{color:"orange"}}>ATV</h3>
          </div>
        </div>
        <div className="box">
          <img src="src/assets/images/wahana-4.jfif" alt="" />
          <div className="content">
            <h3 style={{color:"orange"}} >Feeding Zoo</h3>
          </div>
        </div>
      </div>
    </section>
